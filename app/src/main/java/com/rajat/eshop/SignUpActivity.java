...
public class SignUpActivity extends ActionBarActivity implements AdapterView.OnItemSelectedListener{
    private String[] dropDown={"SignUpActivity as","Customer","Shopkeeper"};
...
//        spinner.setVisibility(View.GONE);
    ...
    public void signup(View view){
        ...
        if(!userName.equals("") && !password.equals("") && !addressss.equals("") && !phoneNumber.equals("")) {
            ...
            VolleyClick.signUp(user.getText().toString(), pass.getText().toString(), address.getText().toString(), phoneNum.getText().toString(), selState, this);
            }else{
                if(userName.length()<=5){
                    Toast.makeText(SignUpActivity.this,"Username should have atleast 5 characters",Toast.LENGTH_SHORT).show();
                }else if(password.length()<=7){
                    Toast.makeText(SignUpActivity.this,"Password should have atleast 7 characters",Toast.LENGTH_SHORT).show();
                }else if(addressss.length()<=7){
                    Toast.makeText(SignUpActivity.this,"Address should have atleast 7 characters",Toast.LENGTH_SHORT).show();
                }else if(phoneNumber.length()<=6){
                    Toast.makeText(SignUpActivity.this,"Phone number should have atleast 6 characters",Toast.LENGTH_SHORT).show();
                }
            }
