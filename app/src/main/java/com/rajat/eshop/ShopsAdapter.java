...
//    HashMap<String ,ArrayList<String>>photoUrl;
    ...
    public ShopsAdapter(ArrayList<String> shops,HashMap<String ,ArrayList<Boolean>>deliverable,Context context){
        super();
        this.shops=shops;
...
//                photoUrls=photoUrl.get(shops.get(position));
                ...
                intent.putExtra("data", new Gson().toJson(ShopsActivity.shop_discount_details.get(shops.get(position))));
