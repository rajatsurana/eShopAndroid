...
//    ArrayList<String> photoUrls =new ArrayList<String>();
    public ProductsGridAdapter(Context context, int count, ArrayList<Product> productObjList){
...
//    this.photoUrls=photoUrls;
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        String photoUrl =productObjList.get(position).getPhotoUrl();
        if(!photoUrl.equals(""))
            CallVolley.getBitmapFromUrl(photoUrl, context, imageView);
//        imageView.setImageResource(product_image.get(position));
    ...
    private void loadPhoto(ImageView iv,String name, int width, int height) {
        ...
        View layout = inflater.inflate(R.layout.custom_fullimage_dialog,
                (ViewGroup) ProductsActivity.lay);
