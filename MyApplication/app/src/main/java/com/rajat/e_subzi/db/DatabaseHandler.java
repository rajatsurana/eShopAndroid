...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public boolean create(NotificationObject myObj) {
    ...
    public ArrayList<NotificationObject> readAllNotifications() {

        ArrayList<NotificationObject> recordsList = new ArrayList<NotificationObject>();
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                int notificationId = cursor.getInt(cursor.getColumnIndex(KEY_ID));
                    NotificationObject mv= new NotificationObject(description,notificationId);
                    // add to list
                    recordsList.add(mv);
    ...
    public NotificationObject readMyNotificationAtPosition(int position) {
        List<NotificationObject> recordsList = new ArrayList<NotificationObject>();
        ...
        if (cursor.moveToFirst()) {
            ...
            mv= new NotificationObject(description,notificationId);//brand,model,plateNumb, Double.valueOf(mileag)
            // add to list
            //recordsList.add(mv);
